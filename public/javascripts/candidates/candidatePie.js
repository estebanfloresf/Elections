function drawPieChart(candidate) {
  ...
  var width = 80,
    ...
    // for animation
    innerRadiusFinal = outerRadius * 0.75,
    innerRadiusFinal3 = outerRadius * 0.65,
  ...
  vis
    ...
    .attr("text-anchor", "middle")
    .html(formatPercent(dataset[0].percentage))
    .attr("class", "perc-" + id);
  ...
  function click(d) {
    ...
    var colorID = d3
      .select(`#${id}-${province.replace(/ +/g, "").trim()}`)
      .attr("fill");
